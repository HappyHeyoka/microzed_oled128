...
/* Definitions for peripheral AXI_GPIO_OLED_CONTROL */
#define XPAR_AXI_GPIO_OLED_CONTROL_BASEADDR 0x41200000
#define XPAR_AXI_GPIO_OLED_CONTROL_HIGHADDR 0x4120FFFF
#define XPAR_AXI_GPIO_OLED_CONTROL_DEVICE_ID 0
#define XPAR_AXI_GPIO_OLED_CONTROL_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_OLED_CONTROL_IS_DUAL 0


/******************************************************************/

/* Canonical definitions for peripheral AXI_GPIO_OLED_CONTROL */
#define XPAR_GPIO_0_BASEADDR 0x41200000
#define XPAR_GPIO_0_HIGHADDR 0x4120FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_AXI_GPIO_OLED_CONTROL_DEVICE_ID
